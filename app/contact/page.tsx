...
export default function ContactPage() {
  ...
  const canSubmit = useMemo(() => {
    return subject.trim().length > 0 && message.trim().length > 0 && contactEmail.trim().length > 0;
            ...
            <div className="card">
              ...
              <form onSubmit={handleSubmit} className="mt-6 space-y-5">
                <div className="space-y-2">
                  <label className="text-sm font-medium text-[var(--text-body)]" htmlFor="contact-category">
                    カテゴリ
                  </label>
                  <select
                    id="contact-category"
                ...
                <div className="space-y-2">
                  <label className="text-sm font-medium text-[var(--text-body)]" htmlFor="contact-subject">
                    件名
                  </label>
                  <input
                    id="contact-subject"
                ...
                <div className="space-y-2">
                  <label className="text-sm font-medium text-[var(--text-body)]" htmlFor="contact-message">
                    内容
                  </label>
                  <textarea
                    id="contact-message"
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  <div className="space-y-2">
                    <label className="text-sm font-medium text-[var(--text-body)]" htmlFor="contact-name">
                      お名前
                    </label>
                    <input
                      id="contact-name"
                  ...
                  <div className="space-y-2">
                    <label className="text-sm font-medium text-[var(--text-body)]" htmlFor="contact-email">
                      返信用メールアドレス
                    </label>
                    <input
                      id="contact-email"
