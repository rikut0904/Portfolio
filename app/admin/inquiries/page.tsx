      ...
      <main className="max-w-6xl mx-auto px-2 sm:px-4 lg:px-8 py-4 sm:py-8">
        <div className="bg-white p-4 sm:p-6 rounded-lg shadow">
          <div className="flex flex-wrap items-center justify-between gap-3 mb-4">
            <div>
              <h1 className="text-lg sm:text-2xl font-bold text-gray-900">お問い合わせ一覧（管理者）</h1>
              <p className="text-sm text-gray-600">送信されたお問い合わせの内容を確認できます</p>
            </div>
            <Link href="/admin" className="text-sm text-blue-800 hover:text-gray-900">
              ダッシュボードへ戻る
            </Link>
          </div>
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4 mb-6">
            <div className="space-y-2">
              <label className="text-sm font-medium text-gray-700" htmlFor="inquiry-user-filter">
                検索
              </label>
              <input
                  ...
                  {sortedItems.map((item) => (
                    <tr key={item.id} className="bg-white">
                      ...
                      <td className="px-3 py-2">
                        <div className="text-gray-900">{item.contactName || "-"}</div>
