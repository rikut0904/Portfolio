...
export default function SectionForm({ section, onSave, onCancel, onMetaUpdate }: SectionFormProps) {
  ...
  const renderFormContent = () => {
    switch (section.meta.type) {
      case "profile":
      case "single":
        return <ProfileSectionForm formData={formData} setFormData={setFormData} />;
      case "list":
        return <ListSectionForm formData={formData} setFormData={setFormData} />;
      case "history":
        return (
          <HistorySectionForm
            formData={formData}
      ...
      case "categorized":
        return <CategorizedSectionForm formData={formData} setFormData={setFormData} />;
      default:
        return (
          <div>
